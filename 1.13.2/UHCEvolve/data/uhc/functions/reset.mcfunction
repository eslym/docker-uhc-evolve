...
#scoreboard objectives remove friend_pos
...
#scoreboard objectives remove first_day
...
#scoreboard objectives remove temp_hit_m
#scoreboard objectives remove hit_adv_buffer
...
#scoreboard objectives remove final_hit
#scoreboard objectives remove final_hit_m
...
#scoreboard objectives remove think
...
#scoreboard objectives remove BR_size
